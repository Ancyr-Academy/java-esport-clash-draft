...
public class CancelMatchCommandHandlerTests {
  ...
  CancelMatchCommandHandler createUseCase() {
  ...
  class Scenario_HappyPath {
    ...
    void shouldCancelTheMatch() {
      CancelMatchCommand input = new CancelMatchCommand(damwonVsG2.getId());
  ...
  class Scenario_MatchDoesNotExist {
    CancelMatchCommand input = new CancelMatchCommand("skt-g2");
